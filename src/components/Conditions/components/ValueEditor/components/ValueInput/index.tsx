...
const ValueInput = ({
    ...
    const handleBlur = (value:string) => dispatch({type: 'valueSet', conditionId, index, value})
    return (
        <Input
        ...
        label={<Button icon onClick={() => dispatch({type:'valueDelete', conditionId, index})}><Icon name='delete'/></Button>}
        labelPosition='right'
        value={temp}
        />
)}
